...
# Пороги 0.5 - временные, до калибровки на корпусе ИТС (backlog E4). Прежние
# значения (0.53 на старом корпусе, 0.55 на старом чанкинге) недействительны:
# состав чанков изменился после исправления чанкера, распределения сходств - тоже.
